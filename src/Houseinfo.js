...
const House = ({ house_id, usage_status, management_status, billing_deadline, vat, lessor_name, town, lot_number, unit_number, building_name, postal_code, address,
    ...
    electricity_meter_date, electricity_payment_type, gas_meter_date, gas_payment_type, other_fee, cable_fee, internet_fee }) => {
...
class HouseInfo extends Component {
    ...
    handleRegisterClick = () => {
        this.props.navigate("/house/new"); // `navigate`을 props로 전달받음
    };            
